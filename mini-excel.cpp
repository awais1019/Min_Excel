...
public:
  ...
  void writeToFile(string filename = "sheet.txt")
  {
    ...
    for (Cell *row = head; row != nullptr; row = row->down)
    {
      ...
      {
        if (col->value.empty() || col->value.find_first_not_of(' ') == string::npos)
        {
...
void Runner(MiniExcel c1)
{
  while (true)
  {
    ...
    if (GetAsyncKeyState('Q'))
    {
      ...
      cin >> endingrange;
      int ans = c1.RangeSum(startingrange, endingrange);
    ...
    if (GetAsyncKeyState('G'))
    {
      ...
      cout << "Enter Ending Cell:";
      cin >> endingrange;
      int ans = c1.RangeAvg(startingrange, endingrange);
      string val = to_string(ans);
      c1.SetCurrentValue(val);
      system("cls");
      color1(7);
    ...
    if (GetAsyncKeyState('O'))
    {
      ...
      cout << "Enter Ending Cell:";
      cin >> endingrange;
      int ans = c1.Count(startingrange, endingrange);
      string val = to_string(ans);
      c1.SetCurrentValue(val);
      system("cls");
    ...
    if (GetAsyncKeyState('M'))
    {
      ...
      cout << "Enter Ending Cell:";
      cin >> endingrange;
      int ans = c1.Max(startingrange, endingrange);
      string val = to_string(ans);
      c1.SetCurrentValue(val);
      system("cls");
      color1(7);
    ...
    if (GetAsyncKeyState('I'))
    {
      ...
      cout << "Enter Ending Cell:";
      cin >> endingrange;
      int ans = c1.Min(startingrange, endingrange);
      string val = to_string(ans);
      c1.SetCurrentValue(val);
      system("cls");
      color1(7);
...
main()
{
  ...
  while (true)
  {
    ...
    if (GetAsyncKeyState(VK_RETURN))
    {
      ...
      if (value == 1 && GetAsyncKeyState(VK_RETURN))
      {
        system("cls");
        MiniExcel c1(1);
        Runner(c1);
      }
      if (value == 2 && GetAsyncKeyState(VK_RETURN))
      {
        help();
        Sleep(1000);
        system("cls");
      }
      if (value == 3 && GetAsyncKeyState(VK_RETURN))
      {
        system("cls");
        break;
      }
